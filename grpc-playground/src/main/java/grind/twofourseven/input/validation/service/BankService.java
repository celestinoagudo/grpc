package grind.twofourseven.input.validation.service;

import com.google.common.util.concurrent.Uninterruptibles;
import grind.twofourseven.input.validation.repository.AccountRepository;
import grind.twofourseven.input.validation.validator.RequestValidator;
import grind.twofourseven.model.input.validation.*;
...
public class BankService extends BankServiceGrpc.BankServiceImplBase {
    ...
    public void getAccountBalance(final BalanceCheckRequest request,
        ...
        RequestValidator.validateAccount(request.getAccountNumber()).map(Status::asRuntimeException)
